        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="loginForm.jsp">메모작성</a></li>
              <li><a class="dropdown-item" href="logoutCheck.jsp">메모보기</a></li>
            </ul>
          </li>
           <li class="nav-item dropdown">
           ...
           <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="loginForm.jsp">회원관리</a></li>
              <li><a class="dropdown-item" href="logoutCheck.jsp">게시물관리</a></li>
